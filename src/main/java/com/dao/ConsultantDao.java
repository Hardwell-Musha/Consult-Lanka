...
public class ConsultantDao {
	...
	public boolean registerConsultant(Consultant d) {
		boolean f = false;
	...
	public boolean updateConsultant(Consultant d) {
		boolean f = false;
	...
	public int countAppointmentByConsultantId(int cid) {
		int i = 0;
		try {
	...
	public boolean editConsultantProfile(Consultant d) {
		boolean f = false;
